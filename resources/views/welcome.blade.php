...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        ...
                                        <ul id="filter-list" class="clearfix">
                                           ...
                                           {{--  @foreach($categories as $key=> $v_categories)
                                            <li class="filter" data-filter="#{{ $v_categories -> title }}">{{ $v_categories -> title }}
                                                <span class="badge">{{ $v_categories -> items -> count() }}</span></li>
                                            @endforeach --}}

                                            @foreach($categories as $v_categories)
                                            <li class="filter" data-filter="#{{ $v_categories -> title }}">{{ $v_categories -> title }}
                                            <span class="badge">{{ $v_categories->item->count() }}</span></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="row">  
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            @foreach($items as $v_items)
                                <li class="item" id = "{{ $v_items->category->title }}">

                                    <a href="#">
                                        <img src="{{ asset('uploads/item/'.$v_items->image) }}" class="img-responsive" alt="Item" style="height: 250px;width: 300px;" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Prawn Dish</h3>
                            ...
                            <div class="flexslider-container">
                                <div class="flexslider">
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <img src="{{asset('uploads/slider/'.$v_slider->image)}}" />
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
                    ...
                    <div class=" section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <form class="reservation-form" method="post" action="{{route('customer.reservation')}}">
                                    @csrf
                                    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                        <div class="row">
                             <form class="contact-form" method="post" action="{{ route('customer.contact') }}">
                                @csrf
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                Copyright, 2019 <a href="{{ route('welcome') }}"> <span style="color: yellow;font-weight: bold;">Resturant System</span></a> Theme by <a href="http://themewagon.com/"  target="_blank"><span style="color: yellow;font-weight: bold;">Najmun_Nafiz </span></a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        {{-- For date and time handling any type... --}}
        <script>
            $(function(){
